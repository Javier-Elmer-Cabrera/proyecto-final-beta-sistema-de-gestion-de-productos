...
public class AppFrame extends JFrame {
    ...
    private JMenuBar getMenuBarr() {
        if (menuBar == null) {
            ...
            /*
              First menu -
             */
            JMenu startMnu = new JMenu("Inicio");
            JMenuItem logOutMnuItem = new JMenuItem("Cerrar Sesión");
            logOutMnuItem.addActionListener(e -> LogOutButton.handleLogout());
            startMnu.add(logOutMnuItem);
            JMenuItem exitMnuItem = new JMenuItem("Salir");
            ...
            /*
              Menú de Entrada
             */
            JMenu entryMenu = new JMenu("Entrada");
            JMenu initRecordMenuSub = new JMenu("Registros Iniciales");

            initRecordMenuSub.add(ActionMenuItem.create("Agregar Categoría", "a", com.ca.ui.panels.CategoryPanel.class.getName()));
            initRecordMenuSub.add(ActionMenuItem.create("Agregar Proveedor", "vendor", com.ca.ui.panels.VendorPanel.class.getName()));
            initRecordMenuSub.add(ActionMenuItem.create("Agregar Tipo de Unidad", "a", com.ca.ui.panels.UnitsStringPanel.class.getName()));
            ...
            JMenuItem jmChang = new JMenuItem("Cambiar Usuario/Contraseña");
            jmChang.addActionListener(e -> {
                if (isLoggedIn) {
                    GDialog cd = new GDialog(AppFrame.this, "Cambiar Usuario/Contraseña", true);
    ...
    private JPanel getToolBarPanel() {
        if (toolBarPanel == null) {
            ...
            buttons.add(ActionButton.create("Inicio", "home", com.ca.ui.panels.HomeScreenPanel.class.getName()));
            buttons.add(ActionButton.create("Consultar Stock", "find", com.ca.ui.panels.StockQueryPanel.class.getName()));
            buttons.add(ActionButton.create("Registrar Productos", "itementry", com.ca.ui.panels.ItemEntryPanel.class.getName()));
            buttons.add(ActionButton.create("Órdenes de Compra", "stock", com.ca.ui.panels.PurchaseOrderPanel.class.getName()));

            buttons.add(new JLabel());
            buttons.add(LogOutButton.create("Cerrar Sesión", "logout", com.ca.ui.panels.HomeScreenPanel.class.getName()));
            buttons.add(ExitButton.create("Salir", "exit", com.ca.ui.panels.HomeScreenPanel.class.getName()));
