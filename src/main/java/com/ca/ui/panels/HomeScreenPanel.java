...
public class HomeScreenPanel extends AbstractFunctionPanel {
    ...
    public HomeScreenPanel() {
        ...
        JLabel lblWelcome = new JLabel("Bienvenido, use la barra de herramientas y menús para continuar. \nSi es la primera vez que ejecuta la aplicación, asegúrese de ingresar los datos iniciales desde Entrada -> Registros Iniciales");
