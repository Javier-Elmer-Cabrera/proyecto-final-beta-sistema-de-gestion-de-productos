...
public class CategoryPanel extends AbstractFunctionPanel {
    // --
    private final String[] header = new String[]{"N.°", "ID", "Nombre", "Tipo", "Especif.1", "Especif.2", "Especif.3", "Especif.4",
            "Especif.5", "Especif.6", "Especif.7", "Especif.8", "Especif.9", "Especif.10"};
    ...
    private void deleteSelectedBranchOffice() {
        try {
            MemoryRepository.getInstance().deleteById(Category.class, editingPrimaryId);
            changeStatus(Status.READ);
    ...
    private void initValidator() {
        ...
        v.addTask(txtName, "El Nombre es Requerido", null, true);
        v.addTask(sp1, "Al menos una Especificación es necesaria", null, true);
    ...
    private void save(boolean isModified) {
        ...
        if (isThereNoDiscontinuity()) {
            try {
                ...
                if (isModified) {
                    Category bo = (Category) MemoryRepository.getInstance().getById(Category.class, editingPrimaryId);
    ...
    private JPanel getUpperFormPanel() {
        if (formPanel == null) {
            ...
            formPanel.setBorder(new TitledBorder(null, "Información de Categoría", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            ...
            rdbtnReturnable = new JRadioButton("Retornable");
            typePanel.add(rdbtnReturnable);

            rdbtnNonReturnable = new JRadioButton("No Retornable");
            ...
            JLabel lblSpecification = new JLabel("Especificación1");
            ...
            JLabel lblSpecification_1 = new JLabel("Especificación2");
            ...
            JLabel lblSpecification_2 = new JLabel("Especificación3");
            ...
            JLabel lblSpecification_3 = new JLabel("Especificación4");
            ...
            JLabel lblSpecification_4 = new JLabel("Especificación5");
            ...
            JLabel lblSpecification_5 = new JLabel("Especificación6");
            ...
            JLabel lblSpecification_6 = new JLabel("Especificación7");
            ...
            JLabel lblSpecification_7 = new JLabel("Especificación8");
            ...
            JLabel lblSpecification_8 = new JLabel("Especificación9");
            ...
            JLabel lblSpecification_9 = new JLabel("Especificación10");
    ...
    private void readAndShowAll(boolean showSize0Error) {
        try {
            List<Category> brsL = MemoryRepository.getInstance().readAll(Category.class);
            editingPrimaryId = -1;
    ...
    public final String getFunctionName() {
        return "Agregar/Ver/Editar Categoría";
    }
    ...
    private void populateSelectedRowInForm(int selectedId) {
        try {
            Category bro = (Category) MemoryRepository.getInstance().getById(Category.class, selectedId);
            if (bro != null) {
