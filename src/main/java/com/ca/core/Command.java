 ...
 * 
 *   execute(): ejecuta la acción (ej: procesar una orden de compra)
 *   undo(): revierte la acción, restaurando el estado anterior
 *       (ej: devolver la orden a la cola y restaurar el stock)
 * 
 * 
 *
 * 
